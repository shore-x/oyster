...
- 状态：Accepted
- 日期：2026-07-22
- 关联文档：[Product Brief](../product/product-brief.md)、[本地 Agent 发现与历史同步 MVP](../product/local-agent-discovery-mvp.md)、[可行性分析](../architecture/agent-knowledge-hub-feasibility.md)、[本机 Agent 发现与存量数据定位](../architecture/agent-discovery-and-history-import.md)
